  ...
  <div class="card-group mx-4 mb-3">
    ...
    <div class="card mr-4">
      ...
      <div class="card-body">
        ...
        <p>power up preferé : Etoile </p>
        <p>Avec son etoile, ce joueur ira plus vite et sera invicible pour un temps limité. Toutefois ne vous approchez pas de lui ou vous risquez de perdre le controle. </p>
      </div>
    </div>
  </div>`
  )
